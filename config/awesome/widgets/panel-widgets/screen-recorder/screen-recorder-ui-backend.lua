...
local screen_rec_backend = require('widgets.panel-widgets.screen-recorder.screen-recorder-scripts')


-- The screen-recorder's UI
local screen_rec_ui = require('widgets.panel-widgets.screen-recorder.screen-recorder-ui')
